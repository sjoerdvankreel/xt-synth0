...
namespace Xt.Synth0
{
	...
	internal static unsafe class Native
	{
		...
		[DllImport("XT.Synth0.DSP")] internal static extern void XtsSynthModelInit(SynthModel.ParamInfo* infos, int infoCount, SynthModel.SyncStep* steps, int stepCount);
	}
}