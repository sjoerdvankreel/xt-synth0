...
void XTS_CALL XtsPlotOutputDestroy(Xts::PlotOutput* output) { delete output; }
...
Xts::PlotOutput* XTS_CALL XtsPlotOutputCreate(void) { return new Xts::PlotOutput; }
...
XTS_EXPORT void XTS_CALL XtsPlotDSPRender(Xts::PlotDSP* dsp, Xts::PlotInput const* input, Xts::PlotOutput* output) { dsp->Render(*input, *output); }
