...
namespace Xt.Synth0.Model
{
	public unsafe sealed class PatternFx : ISubModel
	{
		...
		static readonly ParamInfo ValueInfo = ParamInfo.Lin(p => &((Native*)p)->value, nameof(Value), 0, 255, 0);
		static readonly ParamInfo TargetInfo = ParamInfo.Lin(p => &((Native*)p)->target, nameof(Target), 0, 255, 0);
	}
}