...
namespace Xt.Synth0.Model
{
    ...
    public unsafe sealed class AmpModel : IAutomationGroupModel
    {
        ...
        static readonly ParamInfo PanModAmountInfo = ParamInfo.Mix(p => &((Native*)p)->panModAmount, 0, nameof(PanModAmount), "Amt", "Pan mod amount", false);
        static readonly ParamInfo PanModSourceInfo = ParamInfo.List<ModSource>(p => &((Native*)p)->panModSource, 0, nameof(PanModSource), nameof(PanModSource), "Pan mod source", false, ModModel.ModSourceNames);
        ...
        static readonly ParamInfo Unit1AmountInfo = ParamInfo.Level(p => &((Native*)p)->unitAmount[0], 2, nameof(Unit1Amount), "Ut1", "Unit 1 amount", false, 255);
        static readonly ParamInfo Unit2AmountInfo = ParamInfo.Level(p => &((Native*)p)->unitAmount[1], 2, nameof(Unit2Amount), "Ut2", "Unit 2 amount", false, 0);
        static readonly ParamInfo Unit3AmountInfo = ParamInfo.Level(p => &((Native*)p)->unitAmount[2], 2, nameof(Unit3Amount), "Ut3", "Unit 3 amount", false, 0);
        ...
        static readonly ParamInfo Filter1AmountInfo = ParamInfo.Level(p => &((Native*)p)->filterAmount[0], 2, nameof(Filter1Amount), "Ft1", "Filter 1 amount", false, 0);
        static readonly ParamInfo Filter2AmountInfo = ParamInfo.Level(p => &((Native*)p)->filterAmount[1], 2, nameof(Filter2Amount), "Ft2", "Filter 2 amount", false, 0);
        static readonly ParamInfo Filter3AmountInfo = ParamInfo.Level(p => &((Native*)p)->filterAmount[2], 2, nameof(Filter3Amount), "Ft3", "Filter 3 amount", false, 0);
    }
}