...
namespace Xt.Synth0.Model
{
    ...
    public unsafe sealed class AmpModel : IUIParamGroupModel
    {
        ...
        {
            { EnvSrc, 0 }, { Lvl, 1 }, { LfoSrc, 2 }, { LfoAmt, 3 },
        ...
        static readonly ParamInfo LfoSrcInfo = ParamInfo.List<AmpLfoSource>(p => &((Native*)p)->lfoSrc, nameof(LfoSrc), "LFO", "Amp LFO source");
        static readonly ParamInfo EnvSrcInfo = ParamInfo.List<AmpEnvSource>(p => &((Native*)p)->envSrc, nameof(EnvSrc), "Env", "Amp env source");
    }
}