...
namespace Xt.Synth0.Model
{
    ...
    public unsafe sealed class AmpModel : IUIParamGroupModel
    {
        ...
        static readonly ParamInfo PanModSourceInfo = ParamInfo.List<ModSource>(p => &((Native*)p)->panModSource, 2, nameof(PanModSource), nameof(PanModSource), "Pan mod source", SynthModel.ModSourceNames);
