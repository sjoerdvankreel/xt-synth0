...
namespace Xt.Synth0.Model
{
    ...
    public unsafe sealed class LfoModel : IUIParamGroupModel
    {
        ...
        static readonly ParamInfo PltyInfo = ParamInfo.List<LfoPolarity>(p => &((Native*)p)->plty, nameof(Plty), "Polarity", "Polarity");
        ...
        static readonly ParamInfo RateInfo = ParamInfo.Time(p => &((Native*)p)->rate, nameof(Rate), nameof(Rate), "Rate milliseconds", 1, 26, RelevanceTime);
    }
}