...
namespace Xt.Synth0.Model
{
    ...
    public unsafe sealed class EnvModel : IUIParamGroupModel
    {
        ...
        static readonly ParamInfo DStpInfo = ParamInfo.Step(p => &((Native*)p)->dStp, 2, nameof(DStp), "D", "Decay steps", 0, 11, RelevanceSync);
        static readonly ParamInfo AStpInfo = ParamInfo.Step(p => &((Native*)p)->aStp, 2, nameof(AStp), "A", "Attack steps", 0, 1, RelevanceSync);
        static readonly ParamInfo RStpInfo = ParamInfo.Step(p => &((Native*)p)->rStp, 2, nameof(RStp), "R", "Release steps", 0, 15, RelevanceSync);
        ...
        static readonly ParamInfo DInfo = ParamInfo.Time(p => &((Native*)p)->d, 2, nameof(D), nameof(D), "Decay milliseconds", 0, 18, RelevanceTime);
        static readonly ParamInfo AInfo = ParamInfo.Time(p => &((Native*)p)->a, 2, nameof(A), nameof(A), "Attack milliseconds", 0, 7, RelevanceTime);
        static readonly ParamInfo RInfo = ParamInfo.Time(p => &((Native*)p)->r, 2, nameof(R), nameof(R), "Release milliseconds", 0, 36, RelevanceTime);
        static readonly ParamInfo HldInfo = ParamInfo.Time(p => &((Native*)p)->hld, 2, nameof(Hld), nameof(Hld), "Hold milliseconds", 0, 0, RelevanceTime);
        static readonly ParamInfo DlyInfo = ParamInfo.Time(p => &((Native*)p)->dly, 2, nameof(Dly), nameof(Dly), "Delay milliseconds", 0, 0, RelevanceTime);
    }
}