...
namespace Xt.Synth0.Model
{
    public unsafe sealed class VoiceFilterModel : IUIParamGroupModel
    {
        ...
        static readonly ParamInfo Mod1SourceInfo = ParamInfo.List<ModSource>(p => &((Native*)p)->mods.mod1.source, 2, nameof(Mod1Source), "Source", "Mod 1 source", true, SourceModModel.ModSourceNames);
        ...
        static readonly ParamInfo Mod2SourceInfo = ParamInfo.List<ModSource>(p => &((Native*)p)->mods.mod2.source, 2, nameof(Mod2Source), "Source", "Mod 2 source", true, SourceModModel.ModSourceNames);
