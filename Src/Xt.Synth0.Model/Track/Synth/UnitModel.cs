...
namespace Xt.Synth0.Model
{
	...
	public unsafe sealed class UnitModel : IThemedSubModel
	{
		...
		static readonly ParamInfo PwmInfo = ParamInfo.Lin(p => &((Native*)p)->pwm, "PWM", 1, 255, 128, null, RelevancePwm);
		static readonly ParamInfo AddTypeInfo = ParamInfo.List<AddType>(p => &((Native*)p)->addType, "Type", AddNames, RelevanceAdd);
		...
		static readonly ParamInfo AddMaxPartsInfo = ParamInfo.Exp(p => &((Native*)p)->addMaxParts, "Hms", 0, 12, 4, RelevanceAddBasic);
		static readonly ParamInfo AddPartsInfo = ParamInfo.Lin(p => &((Native*)p)->addParts, "Hms", 1, 32, 1, null, RelevanceAddCustom);
		static readonly ParamInfo AddRollInfo = ParamInfo.Lin(p => &((Native*)p)->addRoll, "Roll", 0, 255, 0, null, RelevanceAddCustom);
