...
namespace Xt.Synth0.Model
{
	...
	public unsafe sealed class UnitModel : INamedModel
	{
		...
		internal struct Native { internal int type, wave, amp, oct, note, cent, basicAddlogParts, pad__; }
		...
		public IReadOnlyList<Param> Params => new[] { Type, Wave, Amp, Oct, Note, Cent, BasicAddLogParts };
