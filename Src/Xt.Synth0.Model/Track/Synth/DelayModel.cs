...
namespace Xt.Synth0.Model
{
    public unsafe sealed class DelayModel : IUIParamGroupModel
    {
        ...
        static readonly ParamInfo MixInfo = ParamInfo.Level(p => &((Native*)p)->mix, 1, nameof(Mix), "Mix", "Dry/wet", true, 0);
        static readonly ParamInfo OnInfo = ParamInfo.Toggle(p => &((Native*)p)->on, 0, nameof(On), "On", "Enabled", true, false);
        static readonly ParamInfo FeedbackInfo = ParamInfo.Level(p => &((Native*)p)->feedback, 1, nameof(Feedback), "Mix", "Dry/wet", true, 0);
