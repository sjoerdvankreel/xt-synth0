...
namespace Xt.Synth0.UI
{
    public static class SettingsUI
    {
        ...
        {
            var result = Create.Grid(13, 2, true);
            ...
            result.Add(Create.Label("Master", new(7, 0)));
            result.Add(MakeThemeColor(settings, nameof(settings.MasterColor), new(7, 1)));
            result.Add(Create.Label("VFilter", new(8, 0)));
            result.Add(MakeThemeColor(settings, nameof(settings.VoiceFilterColor), new(8, 1)));
            result.Add(Create.Label("GFilter", new(9, 0)));
            result.Add(MakeThemeColor(settings, nameof(settings.GlobalFilterColor), new(9, 1)));
            result.Add(Create.Label("Pattern", new(10, 0)));
            result.Add(MakeThemeColor(settings, nameof(settings.PatternColor), new(10, 1)));
            result.Add(Create.Label("Control", new(11, 0)));
            result.Add(MakeThemeColor(settings, nameof(settings.ControlColor), new(11, 1)));
            result.Add(Create.Label("Settings", new(12, 0)));
            result.Add(MakeThemeColor(settings, nameof(settings.SettingsColor), new(12, 1)));
            return result;
        }
