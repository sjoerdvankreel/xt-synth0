...
XTS_EXPORT int XTS_CALL XtsParamSize(void);
...
XTS_EXPORT int XTS_CALL XtsSynthModelUnitCount(void);
XTS_EXPORT int XTS_CALL XtsSynthModelParamCount(void); 
XTS_EXPORT int XTS_CALL XtsPatternRowMaxFxCount(void);
XTS_EXPORT int XTS_CALL XtsPatternRowMaxKeyCount(void);
XTS_EXPORT int XTS_CALL XtsPatternModelPatternRows(void);
XTS_EXPORT int XTS_CALL XtsPatternModelPatternCount(void);
